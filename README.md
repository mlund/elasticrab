...
Nonlinear displacement follows the NOLB rigid-block extrapolation. It moves each
block by a translation and a rotation about its center of mass, so bonds within a
block remain fixed even for large amplitudes.
